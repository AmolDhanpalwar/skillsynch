...
export default function Step3AdditionalManager({ values, onChange }: Step3AdditionalManagerProps) {
    ...
    <div className="space-y-8">
      <div className="space-y-1">
        ...
        <p className="text-xs text-gray-400 font-body pl-7">
          Review employee self-ratings and add manager ratings and comments.
        </p>
      </div>
      ...
      <section>
                ...
                >
                  ...
                  <td className="px-4 py-2.5">
                    <EditableTextarea
                      ...
                      onChange={(v) => updateRow(row.id, { manager_comment: v })}
                    />
                  </td>
                </tr>
              ))}
        ...
        <div className="mt-4">
          ...
          <textarea
            ...
            rows={2}
            placeholder="Add overall manager comment for additional skills…"
            className="w-full px-2.5 py-2 rounded-lg border border-amber-200 bg-amber-50 text-xs font-body text-amber-900 placeholder-amber-300 resize-none outline-none hover:border-amber-400 focus:border-amber-500 focus:ring-1 focus:ring-amber-100 transition-colors"
          />
        </div>
      </section>
