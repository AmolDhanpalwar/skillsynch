...
export default function Step4PlansManager({ values, onChange }: Step4PlansManagerProps) {
  return (
    <div className="space-y-8">
      <div className="space-y-1">
        ...
        <p className="text-xs text-gray-400 font-body pl-7">
          Review the employee's plan and add your feedback and expectations for the next 6 months.
        </p>
      </div>
      ...
      <section className="space-y-3">
        ...
        <textarea
          ...
          rows={6}
          placeholder="Describe your expectations and development goals for this employee…"
